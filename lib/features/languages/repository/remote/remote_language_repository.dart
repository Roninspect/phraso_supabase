...
final languageRepositroyProvider = Provider<RemoteLanguageRepository>((ref) {
  return RemoteLanguageRepository(client: supabase.Supabase.instance.client);
});

class RemoteLanguageRepository {
  final supabase.SupabaseClient _client;
  RemoteLanguageRepository({required supabase.SupabaseClient client})
      : _client = client;
